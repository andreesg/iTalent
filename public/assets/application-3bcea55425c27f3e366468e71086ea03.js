...
;
(function() {
  var ready, showEventModal, showPublicationModal;

  ready = function() {
    $("#new-publication-btn").click(function() {
      return showPublicationModal();
    });
    return $("#new-event-btn").click(function() {
      return showEventModal();
    });
  };

  showPublicationModal = function() {
    return $('#new-publication-modal').modal('show');
  };

  showEventModal = function() {
    return $('#new-event-modal').modal('show');
  };
...
(function() {
  ...
  $(document).ready(function() {
    return $("div.load-comments > a").click(function() {
      var comment_id, publication_id;
  ...
  $(function() {
    if ($('#publication-infinite-scrolling').size() > 0) {
      return $(window).bindWithDelay('scroll', function() {
        var more_posts_url;
